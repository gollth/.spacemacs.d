...
you should place your code here."
  ...
  ;; Arduino
  (setq arduino-cli-default-fqbn "arduino:avr:nano")
  (setq arduino-cli-default-port "/dev/cu.usbserial-AC00MBHO")
  (add-to-list 'auto-minor-mode-alist '("\\.ino\\'" . arduino-cli-mode))
  (spacemacs/declare-prefix "aa" "Arduino")
  (spacemacs/set-leader-keys "aac" 'arduino-cli-compile)
  (spacemacs/set-leader-keys "aau" 'arduino-cli-compile-and-upload)
  (spacemacs/set-leader-keys "aab" 'arduino-cli-board-list)
